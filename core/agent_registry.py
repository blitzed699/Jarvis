            ...
            if filename.endswith(".py") and filename not in ["__init__.py", "base.py"]:
                try:
                    ...
                    for attr_name in dir(module):
                        ...
                        # Only instantiate actual JARVIS agents.
                        # Imported tools/classes must not be treated as agents.
                        if (
...
AGENT: <agent_name>"""
        ...
        if response_clean == "direct" or (
            response_clean.startswith("direct") and "agent:" not in response_clean
        ):
            return None, "Direct"
    ...
    def critique(
        self, original_task: str, agent_output: str
    ) -> Dict[str, Any]:
        ...
        if "critic_agent" not in self.agents:
            return {
                "success": True,
                "verdict": "PASS",
                "review": "No critic available",
            }

        return self.agents["critic_agent"].run(
            agent_output,
